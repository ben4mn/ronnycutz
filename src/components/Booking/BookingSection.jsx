    ...
    return (
      <section id="book" style={{ padding: '44px 28px', background: '#EEF4FF', borderBottom: '3px solid #111' }}>
        <div style={{ maxWidth: '560px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '30px', fontWeight: 900, marginBottom: '24px' }}>You're Booked! ✂</h2>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <button type="submit" disabled={submitting || !selectedSlot}
            ...
            {submitting ? 'Sending request…' : selectedSlot ? `Request — ${service.name} $${service.price}` : 'Choose a time to continue'}
          </button>
