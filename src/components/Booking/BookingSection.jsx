    ...
    return (
      <section id="book" style={{ padding: '44px 28px', background: '#EEF4FF', borderBottom: '3px solid #111' }}>
        <div style={{ maxWidth: '560px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '30px', fontWeight: 900, marginBottom: '24px' }}>You're Booked! â</h2>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div>
            ...
            {loadingSlots ? (
              ...
              <p style={{ color: '#888', fontSize: '14px', fontStyle: 'italic' }}>No availability on this day â try another.</p>
            ) : (
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              ...
              <textarea placeholder="Notes (optional â style, fade length, etc.)" value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })} rows={3}
          ...
          <button type="submit" disabled={submitting || !selectedSlot}
            ...
            {submitting ? 'Sending requestâ¦' : selectedSlot ? `Request â ${service.name} $${service.price}` : 'Choose a time to continue'}
          </button>
